...
mock
  .onPut("/api/blogs/6596a682103d849b08445e87")
  .reply(200, { result: "Update success" });
...
test("After click button, renders content", () => {
  ...
  const { container } = render(
    <Blog user={user} blog={blog} updateBlogs={() => {}} />,
  );
...
test("Click like button twice", async () => {
  const user = {
    username: "hashery",
    token:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Imhhc2hlcnkiLCJpZCI6IjY1OTU5YzkwYWUyOWYzY2NiZmZiZDhkOSIsImlhdCI6MTcwNDQ0NzE3MH0.94oDJNrP3gIcjNufxBsl_7BjRYepq2kSuw2D2EmdyFQ",
    id: "65959c90ae29f3ccbffbd8d9",
  };
